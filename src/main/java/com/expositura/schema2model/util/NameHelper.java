...
public class NameHelper {
   ...
   *
   * @param jsonFieldName the name of the JSON property
   ...
   *
   * @param propertyName the name of the JSON property being added as a field
   * @param node the JsonNode representing the schema for this property
   ...
   *
   * @param propertyName the name of the property this getter will return
