...
public class MakeUniqueClassName {
  ...
  /**
   * When the class name is not unique we will use two underscore '__' and a digit representing the number of time this
   * class was found
   * @param className The original classname
   * @return The possibly updated but unique classname
   */
  public static String makeUnique(String className) {
    ...
    if (m.matches()) {
      ...
      final Integer number = Integer.valueOf(m.group(2));
