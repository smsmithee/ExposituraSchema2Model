...
public class SerializableHelper {
  ...
  private static final Comparator<JClass> INTERFACE_COMPARATOR = (JClass object1, JClass object2) -> {
  ...
  private static void processMethodCollectionForSerializableSupport(Iterator<JMethod> methods, 
