...
import com.expositura.schema2model.util.NameHelper;
...
public class Schema2Model {
   ...
   *
   * @param config the configuration options (including source and target paths, and other behavioural options) that
   * will control code generation
   * @param logger a logger appropriate to the current context, usually a wrapper around the build platform logger
