 ...
 */
package com.expositura.schema2model.model;
 ...
 * <p>
 * The definition of the enum can be decided by: "enum" (JSON-Schema) "enum" and "javaEnums" (JSON-Schema +
 * jsonschema2pojo extension) "enum" and "javaEnumNames" (JSON-Schema + jsonschema2pojo extension)
 */
