...
/**
 * The level of inclusion to be set for generated java types (to control level of inclusion in case of Jackson
 * serializer). Each level will have its own set of mapping annotations.
 *
 * @see <a href="http://fasterxml.github.io/jackson-annotations/javadoc/2.7/com/fasterxml/jackson/annotation/JsonInclude.Include.html"
...
public enum InclusionLevel {
   ...
   * <ul>
   * <li>null
   * <li>"absent" value of a referential type (like Java 8 `Optional`, or {link
   * java.utl.concurrent.atomic.AtomicReference}); that is, something that would not deference to a non-null value.
   * </ul>
   */
  NON_ABSENT,
  /**
