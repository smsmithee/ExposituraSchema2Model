...
/**
 * Annotates generated Java types using Moshi. The annotations used here are most useful when the JSON fields have
 * characters (like underscores) that are poorly suited for beans. By using the Moshi 'Json' annotation, we are able to
