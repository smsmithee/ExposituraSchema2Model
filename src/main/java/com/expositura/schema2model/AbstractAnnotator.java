...
/**
 * A default implementation of the Annotator interface that makes it easier to plug in different Annotator
 * implementations.
 * <p>
 * Annotators that need the generation configuration should add a constructor with {@link GenerationConfig} arg.
 * Annotators that don't need the configuration need only add a default constructor.
 */
