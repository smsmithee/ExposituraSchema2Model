...
public class FormatRule implements Rule<JType, JType> {
   ...
   * <ul>
   * <li>"format":"date-time" =&gt; {@link java.util.Date} or {@link org.joda.time.DateTime} (if config useJodaDates is
   * set)
   ...
   * @param baseType the type which which is being formatted e.g. for
   * <code>{ "type" : "string", "format" : "uri" }</code> the baseType would be java.lang.String
