...
import com.expositura.schema2model.DefaultGenerationConfig;
import com.expositura.schema2model.GenerationConfig;
import com.expositura.schema2model.Jackson2Annotator;
import com.expositura.schema2model.NoopRuleLogger;
import com.expositura.schema2model.RuleLogger;
import com.expositura.schema2model.SchemaStore;
...
public class RuleFactory {
   ...
   *
   * @param generationConfig The generation config options for type generation. These config options will influence the
   * java code generated by rules created by this factory.
   * @param annotator the annotator used to mark up Java types with any annotations that are required to build JSON
   * compatible types
  ...
  /**
   * Provides a rule instance that should be applied when a property declaration (child of the "properties" declaration)
  ...
  /**
   * Provides a rule instance that should be applied when a property declaration is found in the schema, to assign he
   * digits validation on that property.
   *
  ...
  /**
   * The generation config options for type generation. These config options will influence the java code generated by
