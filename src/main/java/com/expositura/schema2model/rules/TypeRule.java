...
public class TypeRule implements Rule<JClassContainer, JType> {
   ...
   * <p>
   * When applied, this rule reads the details of the given node to determine the appropriate Java type to return. This
   * may be a newly generated type, it may be a primitive type or other type such as {@link java.lang.String} or
   * {@link java.lang.Object}.
   * <p>
   * JSON schema types and their Java type equivalent:
   * <ul>
   * <li>"type":"any" =&gt; {@link java.lang.Object}
   * <li>"type":"array" =&gt; Either {@link java.util.Set} or {@link java.util.List}, see {@link ArrayRule}
   ...
   * <li>"type":"string" =&gt; {@link java.lang.String} (or alternative based on presence of "format", see
   * {@link FormatRule})
   * </ul>
   *
