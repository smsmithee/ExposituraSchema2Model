...
import com.expositura.schema2model.util.Models;
...
public class DynamicPropertiesRule implements Rule<JDefinedClass, JDefinedClass> {
  ...
  /**
   * This rule adds dynamic getter, setter and builder methods based on the properties and additional properties defined
   * in a schema.
   * <p>
   * If accessors are being generated, then methods for getting and setting properties by name will be added. These
   * methods first attempt to call the appropriate getter or setter for the property. If the named property is not
   * defined, then the additional properties map is used.
   * <p>
   * If builders are being generated, then a method for building properties by name will be added. This method first
   * attempts to call the builder for the property. If no property with the supplied name is defined, then the
   * additional properties map is used.
   * <p>
   * The methods generated by this class throw an IllegalArgumentException, if the name specified for the property is
   * unknown and additional properties are not enabled. A ClassCastException will be thrown, when the value being set is
   * incompatible with the type of the named property.
   *
