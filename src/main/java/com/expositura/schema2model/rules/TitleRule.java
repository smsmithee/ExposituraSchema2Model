...
public class TitleRule implements Rule<JDocCommentable, JDocComment> {
   ...
   * <p>
   * When a title node is found and applied with this rule, the value of the title is added as a JavaDoc comment. This
   * rule is typically applied to the generated field, generated getter and generated setter for the property.
   * <p>
   ...
   * @param generatableType comment-able code generation construct, usually a field or method, which should have this
   * title applied
