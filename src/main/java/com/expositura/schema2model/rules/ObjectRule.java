...
import com.expositura.schema2model.AnnotationStyle;
...
import com.expositura.schema2model.util.ParcelableHelper;
import com.expositura.schema2model.util.ReflectionHelper;
import com.expositura.schema2model.util.SerializableHelper;
  ...
  private void addIsEmpty(JDefinedClass jclass) {
    ...
    for (JFieldVar fieldVar : fields.values()) {
      ...
      switch (fieldVar.type().erasure().name()) {
        case "Integer", "Double", "Boolean", "Float", "Long" ->
