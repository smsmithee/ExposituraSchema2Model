...
public class DefaultRule implements Rule<JFieldVar, JFieldVar> {
   ...
   * <li>Using {@link Arrays#asList(Object...)} to initialize the list with the correct default values
   * </ol>
   *
   ...
   * <li>Using {@link Arrays#asList(Object...)} to initialize the set with the correct default values
   * </ol>
   *
