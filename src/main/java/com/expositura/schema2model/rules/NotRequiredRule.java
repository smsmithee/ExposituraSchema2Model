...
public class NotRequiredRule implements Rule<JDocCommentable, JDocCommentable> {
   ...
   * @param node the "not required" node, having a value <code>false</code> or <code>no value</code>
   * @param parent the parent node
   * @param generatableType the class or method which may be marked as "not required"
   * @param schema the schema
   * @return the JavaDoc comment attached to the generatableType, which
   * <em>may</em> have an added not to mark this construct as not required.
   */
  @Override
